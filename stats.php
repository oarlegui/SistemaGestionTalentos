...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/searchpanes/2.0.2/css/searchPanes.bulma.min.css">
...
table.dataTable>tbody>tr.selected>* {
 box-shadow:inset 0 0 0 9999px rgba(72, 95, 199, 0.3);
 color:white
}
...
<?php $FechayHora = date('d-m-Y H:i:s', time()); ?>
        ...
        var table = $('#example').DataTable( {
            ...
            buttons: [
                ...
                text: '<span class="icon has-tooltip-right has-tooltip-arrow" data-tooltip="Copiar Tabla"><i class="fas fa-copy"></i></span>'},
                {
                    ...
                    autoFilter: true,
                    title: null,
                    filename: '<?php echo 'Resultados - '.date('Y-m-d_His').'';?>',
                    ...
                    text: '<span class="icon has-tooltip-right has-tooltip-arrow" data-tooltip="Descargar Excel"><i class="fas fa-file-excel"></i></span>'},
                {
                    ...
                    filename: '<?php echo 'Resultados - '.date('Y-m-d_His');?>',
                    pageSize: 'LETTER',
                    messageTop: 'Resultados de Observaciones',
 ...
 table.on( 'select', function ( e, dt, type, indexes ) {
     if ( type === 'row' ) {
        ...
        window.alert('Implementando Graficos para '+data); //TODO: en data tengo el RUT del funcionario, con eso debo cargar datos en el grafico
     }
 } );  
