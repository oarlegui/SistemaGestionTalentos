      ...
      <div class="login column is-4 ">
          ...
          ?>          
			<div class="notification is-warning">
			  ...
			  Lo sentimos, la sesión ha expirado. Vuelva a <a href="index.php">iniciar sesión</a> para continuar.
			</div>
