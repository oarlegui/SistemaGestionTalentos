...
{   
    ...
    while ($row = mysqli_fetch_assoc($rs))
    {
        ?>
            ...
            <td class="align-middle"><div class="form-check"><input <?php estaChecked($full_rut, $full_rut, $row['preg_id'], 4);?> required class="calc form-check-input" title="Sobre lo Esperado" name="<?php echo htmlspecialchars($row['preg_id']);?>" type="radio" value="4" /></div></td>
            <td class="align-middle"><div class="form-check"><input <?php estaChecked($full_rut, $full_rut, $row['preg_id'], 3);?> required class="calc form-check-input" title="Cumple lo Esperado" name="<?php echo htmlspecialchars($row['preg_id']);?>" type="radio" value="3" /></div></td>
            <td class="align-middle"><div class="form-check"><input <?php estaChecked($full_rut, $full_rut, $row['preg_id'], 2);?> required class="calc form-check-input" title="Debe Mejorar" name="<?php echo htmlspecialchars($row['preg_id']);?>" type="radio" value="2" /></div></td>
            <td class="align-middle"><div class="form-check"><input <?php estaChecked($full_rut, $full_rut, $row['preg_id'], 1);?> required class="calc form-check-input" title="Bajo lo Esperado" name="<?php echo htmlspecialchars($row['preg_id']);?>" type="radio" value="1" /></div></td>
            <td class="align-middle"><div class="form-check"><input class="calc form-control form-control-sm" placeholder="Comentario" maxlength="255" name="c_<?php echo htmlspecialchars($row['preg_id']);?>" size="15" type="text" value="<?php getComentario($full_rut, $full_rut, $row['preg_id']);?>" /></div></td>
            </tr>        
        <?php
...
?>
  ...
  <div class="col text-muted text-end"><h2><i class="bi bi-calculator"></i><span class="promedio" name="promedio"><?php echo getPromedio($full_rut, $full_rut);?></span></h2></div>
  </div>
</div>
<form class="needs-validation" novalidate action="aeva-modificar.php" method="POST">
        ...
        <div class="accordion-item">
          ...
          $prox_año = date('Y-12-31', strtotime('+1 year'));
           ...
           ?>
            ...
            <tr>
                <!-- ********* META 01 ******** -->
                <td><textarea required class="form-control form-control-sm" name="plan_text_meta1" type="text" rows="1" id="plan_text_meta1"><?php echo getPlan($full_rut, $full_rut, 1, 'meta');?></textarea>
                <div class="invalid-feedback">Debe completar al menos 2 Metas</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input max=100 min=1 required class="form-control form-control-sm" value="<?php echo getPlan($full_rut, $full_rut, 1, 'impo');?>" name="plan_imp_01" type="number" id="plan_imp_01"/>
                <div class="invalid-feedback">1 a 100%</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><textarea required class="form-control form-control-sm" type="text" rows="1" name="plan_accion_1" id="plan_accion_1"><?php echo getPlan($full_rut, $full_rut, 1, 'acci');?></textarea>
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input required class="form-control form-control-sm" max="<?php echo $prox_año;?>" value="<?php echo getPlan($full_rut, $full_rut, 1, 'plaz');?>" type="date" name="plan_fecha_meta_01" id="plan_fecha_meta_01" />
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
            </tr>
            ...
            <tr>
                <!-- ********* META 02 ******** -->
                <td><textarea required class="form-control form-control-sm" name="plan_text_meta2" type="text" rows="1" id="plan_text_meta2"><?php echo getPlan($full_rut, $full_rut, 2, 'meta');?></textarea>
                <div class="invalid-feedback">Debe completar al menos 2 Metas</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input max=100 min=1 required class="form-control form-control-sm" value="<?php echo getPlan($full_rut, $full_rut, 2, 'impo');?>" name="plan_imp_02" type="number" id="plan_imp_02"/>
                <div class="invalid-feedback">1 a 100%</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><textarea required class="form-control form-control-sm" type="text" rows="1" name="plan_accion_2" id="plan_accion_2"><?php echo getPlan($full_rut, $full_rut, 2, 'acci');?></textarea>
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input required class="form-control form-control-sm" value="<?php echo getPlan($full_rut, $full_rut, 2, 'plaz');?>" max="<?php echo $prox_año;?>" type="date" name="plan_fecha_meta_02" id="plan_fecha_meta_02" />
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
            </tr>
            ...
            <tr>
                <!-- ********* META 03 ******** -->
                <td><textarea class="form-control form-control-sm" name="plan_text_meta3" type="text" rows="1" id="plan_text_meta3"><?php echo getPlan($full_rut, $full_rut, 3, 'meta');?></textarea>
                <div class="invalid-feedback">Debe completar al menos 2 Metas</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input max=100 min=1 class="form-control form-control-sm" value="<?php echo getPlan($full_rut, $full_rut, 3, 'impo');?>" name="plan_imp_03" type="number" id="plan_imp_03"/>
                <div class="invalid-feedback">1 a 100%</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><textarea class="form-control form-control-sm" type="text" rows="1" name="plan_accion_3" id="plan_accion_3"><?php echo getPlan($full_rut, $full_rut, 3, 'acci');?></textarea>
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input class="form-control form-control-sm" value="<?php echo getPlan($full_rut, $full_rut, 3, 'plaz');?>" max="<?php echo $prox_año;?>" type="date" name="plan_fecha_meta_03" id="plan_fecha_meta_03" />
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
            </tr>
            ...
            <tr>
                <!-- ********* META 04 ******** -->
                <td><textarea class="form-control form-control-sm" name="plan_text_meta4" type="text" rows="1" id="plan_text_meta4"><?php echo getPlan($full_rut, $full_rut, 4, 'meta');?></textarea>
                <div class="invalid-feedback">Debe completar al menos 2 Metas</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input max=100 min=1 class="form-control form-control-sm" value="<?php echo getPlan($full_rut, $full_rut, 4, 'impo');?>" name="plan_imp_04" type="number" id="plan_imp_04"/>
                <div class="invalid-feedback">1 a 100%</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><textarea class="form-control form-control-sm" type="text" rows="1" name="plan_accion_4" id="plan_accion_4"><?php echo getPlan($full_rut, $full_rut, 4, 'acci');?></textarea>
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
                <td><input class="form-control form-control-sm" max="<?php echo $prox_año;?>" value="<?php echo getPlan($full_rut, $full_rut, 4, 'plaz');?>" type="date" name="plan_fecha_meta_04" id="plan_fecha_meta_04" />
                <div class="invalid-feedback">Complete este campo</div>
                <div class="valid-feedback">OK!</div>
              </td>
            </tr>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <input type="email" class="form-control" id="frm_correo" name="frm_correo" placeholder="lmerino@espiritusanto.cl">
