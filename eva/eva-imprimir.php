    ...
    var table = $('#datatable').DataTable({
      ...
      buttons: [
        ...
        },
        {
          ...
          filename: 'Evaluación - <?php echo $funcionario;?>',
          sheetName: 'Evaluación',
          messageTop: 'Evaluación - <?php echo $funcionario;?>',
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="index.php"><i class="bi bi-file-earmark-person-fill" style="font-size: 1.5rem;"></i> Mi Evaluación</a>
            </li>
            <li class="nav-item">
...
<div class="container my-5 text-start">
  <div class="row align-items-top">   
    ...
    <a href="eva-pdf.php?funcionario=<?php echo $funcionario;?>"><button type="button" class="btn btn-primary"><i class="bi bi-file-earmark-pdf"></i> Generar PDF</button></a>    
    </div>    
  </div>
</div>
</body>
