...
$fecha = fechaAutoEvaluacion($full_rut);
...
AutoEvaluación de <?php echo $nombre." (".$fecha_ae.")";?>
</header>            
    <body>
        <main>
    ...
    <h2><?php echo $nombre." (".$fecha_ae.")";?></h2>
    ...
    <h2>Resumen</h2>
    <?php getResumen($full_rut, $full_rut); ?>
...
<footer>
    <table style="border: 0;" id="firmas">
        <tr>
            <td style="border: 0 none #fff; border-top: 1px solid black;" id="firma"><strong>Funcionario</strong> <small><?php echo $nombre;?></small></td>
            <td style="border: 0;"> </td>
            <td style="border: 0 none #fff; border-top: 1px solid black;" id="firma"><strong>Evaluador</strong> <small><?php echo $nombre;?></small></td>
        </tr>
    </table>
...
use Dompdf\Dompdf;
  ...
  $dompdf->render();
  $dompdf->stream("AutoEvaluación - ".$nombre." - ".$fecha_ae);
?>