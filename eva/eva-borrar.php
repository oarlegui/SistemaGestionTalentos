...
<div class="container my-5 text-center">
  <div class="row align-items-top">    
    ...
    <i class="bi bi-exclamation-triangle-fill"></i><strong> ¡Está acción no es reversible!</strong> ¿Desea borrar definitivamente la Evaluación?
    </div>
    <div class="container my-1 text-start">  
    
    <a href="eva-borrar-conf.php?funcionario=<?php echo $funcionario; ?>"><button type="button" class="btn btn-danger"><i class="bi bi-trash-fill"></i> Borrar</button></a>
